package net.cloud95.android.lession.audio02;
...
public class Audio02Activity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// 載入指定資源編號的音樂並取得編號，第三個參數目前沒有作用,加入聲音檔
	...
	public void clickPlay02(View view) {
		// 播放第一個音效,參數0是優先權,如果有來電則自動變小聲,下一個0是要重複幾次-1是無限次,下一個參數是頻率
